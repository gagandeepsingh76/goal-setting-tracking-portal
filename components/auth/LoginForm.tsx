...
const quickLogins = [
  { label: "Login as Employee (Alice)", email: "alice@company.com" },
  { label: "Login as Manager", email: "manager@company.com" },
  { label: "Login as Admin", email: "admin@company.com" }
];
  ...
  return (
    <Card className="w-full max-w-md border-border/80 bg-card/95 shadow-elevated">
      <CardHeader className="text-center">
        ...
        <CardTitle>Goal Setting & Tracking Portal</CardTitle>
